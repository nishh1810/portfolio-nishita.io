    ...
    <React.Fragment>
      <div className="capstone-project">
        <div className="capstone-container">
          ...
          <h3>Capstone Project: TechBarter Web App</h3>
          <p>The TechBarter Web App is a community-driven platform for buying, selling, and recycling tech parts. It incorporates features like chat systems, wishlist functionality, sales analytics, and order management, aiming to foster a sustainable tech ecosystem.</p>
          ...
          <div className="capstone-section">
            ...
            <a href="https://github.com/nishh1810/TechBarter.git" target="_blank" rel="noopener noreferrer">
